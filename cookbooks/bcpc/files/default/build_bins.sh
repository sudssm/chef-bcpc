...
for package in requests-aws==0.1.5 httplib2==0.9 http://tarballs.openstack.org/sahara/sahara-2014.1.1.tar.gz sahara-dashboard python-saharaclient==0.7.0; do
    # check if url
